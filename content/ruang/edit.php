...
<section class="content">
    ...
    <div class="card">
        ...
        <?php require 'content/ruang/proses/find.php'; ?>

            <form action="index.php?page=ruang&task=updateproses" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ruang" id="nama-ruang" class="form-control" value="<?= $data['nama_ruang'] ?? '' ?>">
                </div>
